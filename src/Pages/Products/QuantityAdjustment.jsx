                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell sx={{ fontSize: "0.8rem" }}>
                      <Stack direction={"row"} spacing={1}>
                        <IconButton
                          onClick={() => fetchProductDetails(product.barcode)}
                        >
      ...
      >
        ...
        <DialogContent>
          {selectedProduct ? (
            <Stack spacing={1}>
              ...
              <Typography>
                <strong>Current Quantity:</strong> {selectedProduct.productQuantity}
              </Typography>
        ...
        <DialogActions>
          <Button onClick={() => setIsModalOpen(false)}>Close</Button>
           <Button variant="outlined" color="error" onClick={() => updateQuantity('sub')}>Subtraction</Button>
                    <Button variant="outlined" color="success" onClick={() => updateQuantity('add')}>Addition</Button>
                    <Button variant="outlined" color="" onClick={() => updateQuantity('adjust')}>Adjust</Button>
        </DialogActions>
      </Dialog>
    </Stack>
  );
